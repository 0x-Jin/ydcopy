        ...
        <div class="modal-dialog" style="width: 1080px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        {{ Form::label('category', '采购分类', ['class'=>'control-label col-md-3']) }}
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        {{ Form::label('kind', '品名', ['class'=>'control-label col-md-3']) }}
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        {{ Form::label('remark', '备注', ['class'=>'control-label col-md-3']) }}
                        <div class="col-md-4">
