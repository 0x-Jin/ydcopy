...
<div class="row form-inline form-ranking">
    ...
    <div class="plat-form">
        ...
        <div class="form-group">
            <label class="control-label">{{ config('self.select.platForms2.label') }}：</label>
            {{ Form::select('platForm', config('self.select.platForms2.opts'), old('platForm'), ['class'=>'form-control', 'tabindex'=>'-1', 'aria-hidden'=>'true']) }}
        </div>
        <div class="form-group">
    ...
    <div class="form-group">
        ...
        <a class="btn btn-success btn-export mr10" data-url="javascript:alert('请先查询!');">
