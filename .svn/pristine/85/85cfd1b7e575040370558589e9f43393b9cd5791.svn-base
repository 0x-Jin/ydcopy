    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="title" class=" col-md-1 col-md-title" style="line-height: 32px;">平台:</label>
            ...
            <div class="main" style="overflow:hidden;">
                <div class="form-group">
                    <label for="title" class=" col-md-1 col-md-title">发起人</label>
                ...
                <div class="form-group accordion-group">
                    ...
                    <div class="col-md-7" style="width: 20%;">
                        {!! Form::text('expire_time', null, ['class' => 'time-plug form-control  datepicker']) !!}
                    </div>
                    <div class="col-md-7" style="width: 20%;">
                        {!! Form::text('op_date', date('Y-m-d',time()), ['class' => 'time-end form-control  datepicker']) !!}
                    </div>
                </div>
                <div class="form-group form-width">
                    ...
                    <div class="col-md-7">
                        <textarea class="form-control" name="body"  type="text" id="title" /></textarea>
                    </div>
                </div>
                <div class="form-group form-width">
                    ...
                    <div class="col-md-7">
                      <span  id='fileupload' class="btn btn-success fileinput-button">
                        ...
                        <table id='addons_list'></table>
                    </div>
                </div>
            </div>
            </div>
                <div class="accordion-body main mian-info in" id="collapseTwo" style="height: auto;">
                    <div class="form-group">
