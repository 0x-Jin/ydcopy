        ...
        <div class="modal-body" style="overflow: hidden;">
            ...
            <div class="main">
                ...
                <div class="form-group accordion-group">
                    ...
                    <label for="title" class="accordion-heading col-md-1 manage-label-add">
                        <button id="open-info "  class=" manage-arrow-add accordion-toggle"  onclick="add_next()" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
                            +
                        </button>
                    </label>
                    @else
                    ...
                    <div class="col-md-7" style="width: 20%;">
                        <select name="current['current_department'][{{$single['detail_id']}}]" checkform-type='required' checkform-msg='部门不能为空' need_reuired="on" class="form-control giveperson" style="width: 50%;margin: 0 auto;">
                    ...
                    <div class="col-md-7" style="width: 20%;">
                        <select name="current['currentone'][{{$single['detail_id']}}]"  checkform-type='required' checkform-msg='员工不能为空' need_reuired="on"   class="form-control toperson" style="width: 50%;margin: 0 auto;">
                        ...
                        <div class="col-md-7" style="width: 20%;">
                            <input  checkform-type='date' checkform-msg='完成时间不正确'  name="current['expire_time'][{{$single['detail_id']}}]" value="@if($single['expire_time']){{date('Y-m-d h:i',$single['expire_time'])}}@endif" type="text" class="time-plug form-control  datepicker " />
                        </div>
                        <div class="col-md-7" style="width: 20%;">
                            <input checkform-type='date' checkform-msg='操作时间不正确'   name="current['op_time'][{{$single['detail_id']}}]" value="@if($single['op_time']){{date('Y-m-d h:i',$single['op_time'])}}@endif" type="text" class="time-end form-control  datepicker " />
                        </div>
                      </div>
                 @if($k == 0)
                <div class="form-group form-width">
                    <label for="title" class=" col-md-1"  style="text-align: left;" checkform-type='required' checkform-msg='标题不能为空' need_reuired="on">标题</label>
                    <div class="col-md-7" style="width:90%">
                        <input class="form-control" name="title" value="{{$mainData['title']}}" type="text" />
                        <span class="error-span"></span>
                    </div>
                </div>
                 @endif
                ...
                <div class="form-group form-width">
                    ...
                    <div class="col-md-7">
                        <input class="form-control" checkform-type='number' checkform-msg='优先级必须为数字'  name="current['rank'][{{$single['detail_id']}}]" value="{{$single['rank']}}" type="text" id="title" style="width: 20%;"/>
                        <span class="error-span"></span>
                    </div>
                </div>
                @endif
            ...
            <div class="accordion-body collapse main mian-info" id="collapseTwo" >
                ...
                <div class="form-group" >
                    ...
                    <div class="col-md-7" style="width: 20%;">
                        <select  name="next[current_department]" checkform-type='required' checkform-quick="on" checkform-msg='流转部门不能为空' need_reuired="on"  class="form-control giveperson" style="width: 50%;margin: 0 auto;">
                    ...
                    <div class="col-md-7" style="width: 20%;">
                            <select name="next[currentone]" checkform-type='required' checkform-quick="on" checkform-msg='流转员工不能为空' need_reuired="on"   class="form-control toperson" style="width: 50%;margin: 0 auto;">
                                <option value="">请选择员工</option>
                            </select>
                    </div>
                    <div class="col-md-7" style="width: 20%;">
                        <input name="next['expire_time']"  type="text" checkform-type='date' checkform-quick="on" checkform-msg='期望日期不正确'    class="time-plug form-control  datepicker" >
                    </div>
                    <div class="col-md-7" style="width: 20%;">
                        <input name="next['op_time']"  type="text" checkform-type='date' checkform-quick="on" checkform-msg='操作日期不正确'  class="time-end form-control  datepicker">
                    </div>
                ...
                <div class="form-group  form-width">
                    <label for="title" class="col-md-1"  style="text-align: left;">优先级</label>
                    <div class="col-md-7">
                        <input class="form-control" name="next[rank]" type="text" checkform-type='number' checkform-msg='优先级必须为数字' >
                        <span class="error-span"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" value="turn" onclick="tosubmit(3)" class="btn btn-success btn-save"  style="display: none" id="turn_node" name="turn">流转</button> 
                @endif
            </div>
            @endif
            {!! Form::close() !!}
