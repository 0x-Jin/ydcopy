        ...
        <div class="modal-body">
            ...
            <div class="main" style="overflow: hidden;">
                ...
                <div class="form-group accordion-group" >
                    ...
                    {!! Form::text('current[expire_time]', date('Y-m-d h:m',$current['data']['expire_time']), ['class' => 'time-plug  form-control datepicker']) !!}
                    @else
                    {!! Form::text('current[expire_time]', date('Y-m-d h:m',time()), ['class' => 'time-plug  form-control datepicker']) !!}
                    @endif
                    @else
                    <div class="col-md-7" style="width: 20%;text-align: center;">
