    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="main" style="overflow:hidden;">
                ...
                <div class="form-group accordion-group">
                    ...
                    <div class="col-md-7" style="width: 20%;">
                        <span class="form-control">  {{$single['data']['current_department']}} </span>
                        <span class="error-span"></span>
                    </div>
                    <div class="col-md-7" style="width: 20%;">
                        <span  class="form-control">  {{$single['data']['currentone']}} </span>
                    </div>
                    <span class="time-plug form-control" style="text-align: center;border: 0px;">{{date('Y-m-d h-m-s',$single['data']['expire_time'])}}</span>
                    <span class="time-end form-control" style="text-align: center;border: 0px;">{{date('Y-m-d h-m-s',$single['data']['op_time'])}}</span>
                </div>
                <div class="form-group form-width">
                    <input name="id" type="hidden" value="2" />
                    <label for="title" class="control-label col-md-1 col-md-info" style="border: 0px">描述</label>
                    <div class="col-md-7">
                        <span class="form-control" id="title" >{{$single['data']['remark']}}</span>
                        <span class="error-span"></span>
                    </div>
                </div>
                <div class="form-group form-width">
            ...
            <div class="main" style="overflow: hidden;">
                ...
                <div class="form-group form-width">
                    ...
                    <div class="col-md-7">
                        ...
                        @else
                            <span class="form-control"> {{$current['data']['remark']}}</span>
                ...
                <div class="form-group form-width">
                    ...
                    <div class="col-md-7">
                        ...
                        @else
                            <span class="form-control" style="text-align: center;border: 0px;width: 100%;"> {{$current['data']['rank']}}
                          </span>
                        @endif
                        <span class="error-span"></span>
                    </div>
                        ...
                        @if($next)
                            <div class="main" style="overflow: hidden;">
                                ...
                                <div class="form-group">
                                    <label for="title" class="accordion-heading control-label col-md-1 manage-label-add">  </label>
                                    <div class="col-md-7" style="width: 20%;">
                                        <span class="form-control">{{$next['data']['current_department']}}</span>
                                        <span class="error-span"></span>
                                    </div>
                                    <div class="col-md-7" style="width: 20%;">
                                        <span  class="form-control">{{$next['data']['currentone']}}</span>
                                    </div>
                                ...
                                <div class="form-group form-width">
                                    ...
                                    <label for="title" class="control-label col-md-1 col-md-info" style="border: 0px">备注</label>
                                    <div class="col-md-7">
                                            <span class="form-control"> {{$next['data']['remark']}}</span>
                                        <span class="error-span"></span>
                                    </div>
                                </div>
                                <div class="form-group form-width">
                                ...
                                <div class="form-group form-width">
                                    ...
                                    <div class="col-md-7">
                                     ...
                                     <span class="form-control" style="text-align: center;border: 0px;width: 100%;">{{$next['data']['rank']}}</span>
            ...
            <div class="modal-footer" id='buttonall'>
                <button type="submit" class="btn btn-success btn-save" id="pass" name="save">保存</button>
                <button type="submit" class="btn btn-warning" id="finish" name="finished">完结</button>
            </div>
                        @endif
