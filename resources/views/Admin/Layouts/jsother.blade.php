<!-- JAVASCRIPTS -->
<!-- JQUERY -->
<script src="{{ asset('assets/js/datatables/media/js/jquery-1.12.0.min.js') }}"></script>
<!-- JQUERY UI-->
...
<script type="text/javascript" src="{{ asset('assets/js/select2/select2.min.js') }}"></script>
<!-- DATA TABLES -->
<script type="text/javascript" src="{{ asset('assets/js/datatables/media/js/jquery.dataTable.js') }}"></script>
...
<!-- CUSTOM SCRIPT -->
<script type="text/javascript" src="{{ asset('assets/js/scriptother.js') }}"></script>
